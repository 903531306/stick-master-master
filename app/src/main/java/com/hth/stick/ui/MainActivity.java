...
//        initData();
        ...
        NoScrollListView listView= (NoScrollListView) findViewById(R.id.list);

        for (int i = 0; i < 50; i++)
        {
            mDatas.add(fragTag + " -> " + i);
        }
        listView.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1,mDatas));
    }
